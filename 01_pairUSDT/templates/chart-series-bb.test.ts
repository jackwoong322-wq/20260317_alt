...
describe('Bollinger Bands Logic Tests', () => {
  ...
  it('11. should not add series if cycleData is null', () => {
    addBollingerBandsSeries(mockState, 'BTC', 'BTC', 'Current', 1, null as any, 'btc_key');
